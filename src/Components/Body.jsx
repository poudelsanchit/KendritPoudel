  ...
  return (
    <>
      <div className=" bg-bg-dark h-auto text-txtprimary font-poppins flex justify-end ">
        <div className="w-2/12  h-full flex justify-center items-center fixed left-0 ">
          ...
          <div className="h-5/6 w-7/12  flex flex-col justify-between  ">
            ...
            <div className="flex flex-col gap-10  text-xl ">
              {links.map((items) => {
                return (
                  <a href={items?.url} target='_blank'> <div className="cursor-pointer h-10 w-10 hover:bg-txtsecondary hover:text-black transition-all rounded-full flex justify-center items-center">
                  {items?.icon}
                </div></a>
        ...
        <div className=" sm:w-8/12 w-10/12 flex flex-col sm:gap-5 gap-20">
          <Intro />
          <AboutMe />
        </div>
